...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| 56227 |	石川県 |	金沢（カナザワ） | 47605 | 2020 | 08 | 15 | 20 | 30 | 0.0 | 80.0 |
...
> プログラムはデータを取得(SJIS)し、コンマを消し見やすくする機能です。そこから石川県(金沢)を検索し表示するためにzinbeijettを使いました。このプログラムがあれば仮にzinbei2wのAPI取得ができなくなっても、代替えとして石川県(金沢)の情報を取得と表示ができます。表内の数字を当てはめるだけで、何度でも更新することができます。たまに更新します。
